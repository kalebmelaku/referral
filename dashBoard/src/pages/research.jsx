  ...
  return (
   <>
    ...
    <form class="shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <h2 className="text-lg dark:text-white text-center">Upload Research Documents</h2>
    <div class="mb-4">
    ...
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" id="username" type="number" min={1900} max={2099} step={1} value={year} onChange={handleInputChange}
      onBlur={handleInputBlur}/>
      {feedback ? <p className='text-red-500 text-xs italic mt-1'>Please enter a year between 1900 and 2099.</p> : null}
    </div>
    <div class="mb-6">
